...
def process_sample(args):
    ...
    model, processor, example, idx, image_dir, max_new_tokens, data_dir = args
...
def main():
    ...
    for batch_idx in range(total_batches):
        ...
        batch_args = [(model, processor, example, batch_start+i, args.image_dir, args.max_new_tokens, data_dir)
