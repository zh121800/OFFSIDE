...
/root/autodl-tmp/output/Qwen2.5-VL-LoRA-vanilla/checkpoint-2000

##Complete unlearning data path: 
#Forget set: /OFFSIDE/data/complete_unlearning_data/forget_set.json
#Retain set: /OFFSIDE/data/complete_unlearning_data/retain_set.json
#Finetune set: /OFFSIDE/data/complete_unlearning_data/finetune_set.json

##Pure text unlearning data path：
#Forget set: /OFFSIDE/data/pure_text_data/forget_set.json
#Retain set: /OFFSIDE/data/pure_text_data/retain_set.json

##Selective unlearning(fine-grained unlearning) data path:
##/OFFSIDE/data/selective_unlearning_data/finetune_set: image path, same to other settings.
#Forget set: /OFFSIDE/data/selective_unlearning_data/forget_set_part.json
#Retain set: /OFFSIDE/data/selective_unlearning_data/retain_set_part.json

##After training, please use this to merge the model with adapter.
swift export \
  --model /root/autodl-tmp/models/Qwen2.5-VL-7B-Instruct \
  --adapters /root/autodl-tmp/output/Qwen2.5-VL-LoRA-vanilla/checkpoint-2000\
  --merge_lora true \
  --output_dir /root/autodl-tmp/output/output/Qwen2.5-VL-7B-LoRA-2000\
  --model_type qwen2_5_vl

##Change the path of data and model according to your own setting.
