...
def parse_args():
    ...
    parser.add_argument("--model_name", type=str, default="Qwen/Qwen2.5-VL-7B-Instruct", 
                        help="Model name")
    parser.add_argument("--model_path", type=str, default="/root/autodl-tmp/OFFSIDE/Qwen2.5-VL-LoRA-vanilla", 
                        help="Pre-trained model path")
    parser.add_argument("--data_path", type=str, default="/root/autodl-tmp/OFFSIDE/OFFSIDE/forget_set.json", 
                        help="Forgetting dataset path")
    parser.add_argument("--output_dir", type=str, default="/root/autodl-tmp/OFFSIDE/OFFSIDE/output_GA/Qwen2.5-VL-LoRA-GA", 
