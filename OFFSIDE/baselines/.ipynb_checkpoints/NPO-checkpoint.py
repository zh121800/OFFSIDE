...
def parse_args():
    ...
    parser.add_argument("--ref_model_path", type=str, default="/root/autodl-tmp/OFFSIDE/OFFSIDE/output/Qwen2.5-VL-LoRA-NPO-reference/checkpoint-1500-merged", 
    ...
    parser.add_argument("--output_dir", type=str, default="/root/autodl-tmp/OFFSIDE/OFFSIDE/output/Qwen2.5-VL-LoRA-npo", 
...
def main():
    ...
    data_dir = os.path.dirname(os.path.abspath(args.forget_data))
    
    # Process data
    train_dataset = train_ds.map(
        lambda example: process_func(example, tokenizer, processor, args.max_length, data_dir)
    )
