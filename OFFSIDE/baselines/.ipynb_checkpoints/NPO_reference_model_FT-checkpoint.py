...
DATA_PATH = "/root/autodl-tmp/OFFSIDE/OFFSIDE/retain_set.json"
OUTPUT_DIR = "/root/autodl-tmp/OFFSIDE/OFFSIDE/output/Qwen2.5-VL-LoRA-NPO-reference"
##########
# Fixed fine-tuning 400 steps
...
def process_func(example, tokenizer, processor, data_dir: str):
    ...
    inputs = processor(
        text=[text],
        images=image_inputs,
        videos=None,  # Do not use video_inputs
        padding=True,
        return_tensors="pt",
    )
...
def main():
    ...
    # Create training arguments and start training
